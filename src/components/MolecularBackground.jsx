...
/**
 * MolecularBackground Component
 * 
 * Logic: Renders a real-time particle system on canvas that mimics 
 * molecular structures. Particles (atoms) move and connect with lines 
 * (bonds) when they are close to each other.
 */
